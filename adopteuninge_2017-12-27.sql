...
# Temps de génération: 2017-12-27 20:26:43 +0000
# ************************************************************
...
INSERT INTO `user` (`id`, `name`, `nickname`, `mail`, `password`, `birth`, `admin`, `rank`, `city`, `zip`, `like`, `report`, `sex`, `orientation`)
VALUES
	(1,'Masson','Tom','tom.masson@insa-rouen.fr','161a2e455baa688c70d01bff63384b30','1996-02-02',1,3,'MSA',12345,10,0,0,1),
	(3,'Marchelidon','Hugo','hugo.marchelidon@insa-rouen.fr','22b6a3594cac7fbbade97039f91f201f','1996-07-07',0,2,'Rouen',32767,10,0,0,0);
